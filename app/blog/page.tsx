...
const staticPosts = [
  // --- NEW BLOGS (Jan 15 - Jan 25, 2026) ---
  {
    ...
    excerpt: "As India celebrates Republic Day, explore how owning land offers true financial independence and a legacy for your family unlike any other asset.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Experts predict a 15-20% appreciation in Dehradun's peripheral areas in 2026. Discover why connectivity and wellness trends are driving this surge.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Savvy investors know January is the best time to inspect hill properties. Learn why winter reveals the true topography, sunlight potential, and accessibility issues.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Maximize your financial portfolio this new year. Learn about Capital Gains exemptions and how land investment acts as a powerful wealth-compounding tool.",
    content: `
  ...
  // --- EXISTING BLOGS ---
  {
    ...
    excerpt: "Uttarakhand’s peaceful environment makes it desirable, but first-time buyers often rush into deals. Learn how to avoid legal pitfalls and verify land-use permissions.",
    content: `
  ...
  },
  {
    ...
    excerpt: "With increasing tourism and improved infrastructure, buying land here is no longer just for scenic living. Understand land types and legal verification processes.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Buying a plot is both a financial and emotional milestone. Start with a clear objective, check location fundamentals, and perform legal due diligence.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Top Reasons to Invest in Residential Plots Near Dehradun",
    content: `
  ...
  },
  {
    ...
    excerpt: "Greater Dehradun is emerging as a prime real estate hub due to the Delhi–Dehradun Economic Corridor, affordable plots, R2 zoning, and upcoming Smart City developments...",
    content: `
  ...
  },
  {
    ...
    created_at: "2025-10-08",
    excerpt: "Most investors make mistakes like wrong location, ignoring legal checks, or expecting short-term returns. Zam’s Gardenia fixes these with location near IIT Patna, Bihta Airport, RERA certification, and easy EMIs...",
    content: `
  ...
  },
  {
    ...
    excerpt: "Introduction: Why Location Is the Heart of Real Estate",
    content: `
  ...
  },
  {
    ...
    excerpt: "दिल्ली–देहरादून इकोनॉमिक कॉरिडोर: रफ्तार और रियल एस्टेट का संगम",
    content: `
  ...
  },
  {
    ...
    excerpt: "फ्यूचर प्रूफ इन्वेस्टमेंट",
    content: `
